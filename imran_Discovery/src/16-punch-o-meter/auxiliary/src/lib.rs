 ...
 pub use f3::{
     hal::{delay::Delay, prelude, stm32f30x::i2c1,time::MonoTimer},
     led::{Direction, Leds},
 ...
 pub fn init() -> (MonoTimer,Leds, Lsm303dlhc, Delay, ITM,&'static mut usart1::RegisterBlock) {
     ...
     //New Imran
     unsafe {
     (mono_timer,leds, lsm303dlhc, delay, cp.ITM,&mut *(USART1::ptr() as *mut _)) }
 }
